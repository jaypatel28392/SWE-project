...
{
								$sql1                     = "SELECT balance FROM journal" . $sender_id . " ORDER BY trans_id DESC LIMIT 1";
								...
								{
																$sql2                     = "SELECT balance FROM journal" . $receiver_id . " ORDER BY trans_id DESC LIMIT 1";
																...
																$sql3                     = "INSERT INTO journal" . $sender_id . " VALUES(
                        NULL,
                        NOW(),
                        'Sent to: " . $row5["first_name"] . " " . $row5["last_name"] . ", Account Number:: " . $row5["account_no"] . "',
                        '$amt',
                        '0',
                        '$updated_sender_balance'
                    )";

																$sql4                     = "INSERT INTO journal" . $receiver_id . " VALUES(
                        NULL,
                        NOW(),
                        'Received from: " . $row0["first_name"] . " " . $row0["last_name"] . ", Account Number:: " . $row0["account_no"] . "',
                        '0',
                        '$amt',

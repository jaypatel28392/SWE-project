...
$sql0             = "SELECT * FROM journal" . $_SESSION['cust_id'];
...
{ ?>
                      ...
                      <option value="transactions.php?sort=tid_down">Transaction ID &darr;</option>
                      <option value="transactions.php?sort=tid_up">Transaction ID &uarr;</option>
